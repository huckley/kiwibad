...
R"PHYPHOXFILE(<phyphox version="1.7">
    ...
    <views>
        <view label="Temperaturverlauf">
            ...
            <graph label="Lufttemperatur" labelX="Uhrzeit (h)" labelY="Temperatur" unitY="°C" partialUpdate="true">
            ...
            <graph label="Wassertemperatur" labelX="Uhrzeit (h)" labelY="Temperatur" unitY="°C" partialUpdate="true">
            ...
            <graph label="Batteriespannung" labelX="Uhrzeit (h)" labelY="Spannung" unitY="mV" partialUpdate="true">
